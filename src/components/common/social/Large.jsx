...
export default function Large({ data }) {
  const click = (link) => {
                  ...
                  >
                    <g>
                      <path
                        ...
                        stroke={data?.iconsColor?.hex ?? item?.iconColor?.hex}
                        fill="transparent"
                        stroke-width="10px"
                      />
                      <path
                        className="st1"
                        fill={data?.iconsColor?.hex ?? item?.iconColor?.hex}
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    color: data?.iconsColor?.hex ?? item?.iconColor?.hex,
                  }}
                ></div>
              </a>
            );
